...
class Bio extends React.Component {
  ...
  render() {
    return (
      // class is set to flex box container, but it's not used in this component except to properly size the whole element, which is an ability granted by having a flex box parent.
      <div id="bio" className="content-box">
        {/* centered */}
        <h2 id="bio-title">About Me</h2>
        {/* margin around these too, to make them fit inside the parent neatly. */}
